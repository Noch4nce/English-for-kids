const cards = [
    ['Action (set A)', 'Action (set B)', 'Animal (set A)', 'Animal (set B)', 'Clothes', 'Emotions', 'Fruits', 'Sport'],
    [
        {
            word: 'cry',
            translation: 'плакать',
    ...
    [
        ...
        },
        {
            ...
            audioSrc: '../assets/audio/football.mp3',
        },
        {
            word: 'basketball',
        ...
        },
        {
            ...
            audioSrc: '../assets/audio/bowling.mp3',
        },
        {
            word: 'surfing',
            translation: 'серфинг',
            image: '../assets/images/surfing.jpg',
            audioSrc: '../assets/audio/surfing.mp3',
        },
    ],
];
